...
⤷ Hi, I'm Karan Kaushal, a passionate, self-taught, highly-motivated, and resourceful web developer from India. I have extensive experience developing the web, and I take great care in the experience, architecture, and code quality of the things I build. My specialties include HTML5, CSS3, JavaScript, and React. I'm also well-versed in MySQL and MongoDB and have experience with other popular web frameworks. I'm also an active member of the open-source community, and I love to explain and teach technology, solve tech problems, and learn something new daily.
